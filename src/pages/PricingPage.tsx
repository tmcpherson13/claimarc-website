...
const tiers: Tier[] = [
  {
    ...
    modules: ["Sentinel", "Ledger", "Forecast"],
    bestFor: "Starting with financial intelligence and visibility",
    ctaText: "Request Pricing",
    ctaHref: "/contact?tier=insight",
  },
  {
    name: "DEFEND",
    recovery: "Platform + recovery share",
    modules: ["All Insight modules +", "Triage", "Shield", "Prevent"],
    bestFor: "Adding denial prevention and triage",
    ctaText: "Request Pricing",
    ctaHref: "/contact?tier=defend",
  },
  {
    name: "RECOVER",
    recovery: "Platform + recovery share",
    modules: ["All Defend modules +", "Evidence", "Resolve"],
    bestFor: "Bulk appeal generation and maximum recovery",
    ctaText: "Request Pricing",
    ctaHref: "/contact?tier=recover",
  },
  {
    name: "INTELLIGENCE",
    recovery: "Platform + recovery + underpayment share",
    modules: ["All 9 modules"],
    bestFor: "Full-platform defense with FHIR integration",
    ctaText: "Request Pricing",
    ctaHref: "/contact?tier=intelligence",
  },
  {
    name: "ENTERPRISE",
    recovery: "Platform + recovery + underpayment share",
    modules: [
      "All 9 modules",
      "Custom integrations",
      "BAA active + dedicated support",
    ],
    bestFor: "Health systems, IDNs, and clearinghouses",
    ...
    <Layout>
      ...
      <section className="bg-[var(--navy)] py-24 px-16">
        ...
        <div className="mt-8 flex gap-4 flex-wrap">
          ...
          <Link
            to="/contact?intent=pricing"
            className="border-2 border-white text-white px-6 py-3 rounded font-semibold"
          >
            Request Pricing
          </Link>
        </div>
      ...
      <section className="bg-white py-24 px-16">
        <h2 className="text-[var(--navy)] text-4xl font-bold">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-14">
          <div className="rounded-xl p-8 border-2 border-[var(--lgray)]">
            ...
            <h3 className="text-[var(--navy)] font-bold text-xl mt-2">
          ...
          <div className="rounded-xl p-8 border-2 border-[var(--emerald)]">
            ...
            <h3 className="text-[var(--navy)] font-bold text-xl mt-2">
              Co-Piloted by ZTech Specialists.
            </h3>
            <p className="text-slate-600 text-sm mt-3">
      ...
      <section className="bg-[var(--lgray)] py-24 px-16">
        ...
        <p className="text-slate-600 text-center mt-2">
          Start where your pain is greatest. Add modules as your organization
          grows.
        </p>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mt-14">
          {tiers.map((t) => (
            <div
              key={t.name}
            ...
            >
              ...
              <Link
                to={t.ctaHref}
                className={`w-full text-center py-2 rounded text-sm mt-4 ${
                  t.highlighted
